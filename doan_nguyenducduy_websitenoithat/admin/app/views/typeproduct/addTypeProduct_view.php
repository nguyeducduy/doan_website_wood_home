            ...
            <div class="main-content">
                <div class="row">
                    <div class="col-md-8 col-md-offset-2">
                        <h2 class="text-center">Thêm Loại bàn ghê</h2>
                        ...
                        <form action="<?php echo site_url('typeproduct/add'); ?>" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                <label for="txtNameType">Tên loại bàn ghế</label>
                                <input type="text" class="form-control" name="txtNameType" id="txtNameType" placeholder="Tên loại bàn ghế">
                            </div>
                            <div class="form-group">
                                <label for="slcGT">Loại bàn ghế</label>
