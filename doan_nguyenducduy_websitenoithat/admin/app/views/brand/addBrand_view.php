            ...
            <div class="main-content">
                <div class="row">
                    <div class="col-md-8 col-md-offset-2">
                        ...
                        <form action="<?php echo site_url('brands/add'); ?>" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                <label for="txtNameBrand">Tên Thương Hiệu</label>
                                <input type="text" class="form-control" name="txtNameBrand" id="txtNameBrand" placeholder="Tên Nhãn Hiệu">
                            </div>
                            <div class="form-group">
                                <label for="txtFile">Logo</label>
